...
def parse_args():
    ...
    parser.add_argument('--input', default='/home/jovyan/model/jbnu/data/0830', help='input')
#     parser.add_argument('--output', default='/home/jovyan/model/jbnu/eval', help='output')
    ...
    parser.add_argument('--model_path', default='/home/jovyan/model/jbnu/unet/iter_20000.pth', help='model_path')
...
def main():
    ...
    args.checkpoint = args.modelpath
